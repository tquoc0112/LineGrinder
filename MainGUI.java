...
public class MainGUI extends JFrame {
	...
	public MainGUI(int width, int height, String title) {
		...
		rbNormal = new JRadioButton("Thường");
		rbHard = new JRadioButton("Khó");
		
		rbHuman = new JRadioButton("Người");
		rbComputer = new JRadioButton("Máy");
		...
		taDifficulty = new JLabel("Độ Khó: ");
		taStartingPlayer = new JLabel("bắt đầu trước.");
