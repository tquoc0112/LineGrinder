...
public class LineGrinder {
    ...
    /*
     * Sets the depth of the minimax tree. (i.e. how many moves ahead should the AI
     * calculate.)
     */
    ...
    public class MouseClickHandler implements Runnable {
        ...
        public void run() {
            ...
            System.out.println("Black: " + Minimax.getScore(board, true, true) + " White: "
    ...
    private int checkWinner() {
        if (Minimax.getScore(board, true, false) >= Minimax.getWinScore())
            return 2;
        if (Minimax.getScore(board, false, true) >= Minimax.getWinScore())
            return 1;
        return 0;
    }
